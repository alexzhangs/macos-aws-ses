...
# Variables
mark_begin="# BEGIN == Generated by macos-aws-ses"
mark_end="# END == Generated by macos-aws-ses"
config="
...
if [[ -n $TEST_EMAIL_SEND_TO ]]; then
    ...
    sendmail -F "macos-aws-ses" -f "no-reply@$SES_DOMAIN" -t "$TEST_EMAIL_SEND_TO" << EOF
Subject: macos-aws-ses test Email
